...
división y se devuelve el resultado al main. * To change this license header, choose License Headers in Project Properties.
 * To change this template file, choose Tools | Templates
 * and open the template in the editor.
 */
package poooperacion;

import CLSS.Operacion;
...
public class POOoperacion {
    ...
    public static void main(String[] args) {
        ...
        operacion.crearOperacion(leer.nextDouble(), leer.nextDouble());
        System.out.println("Ingrese que operación desea llevar a cabo: suma, resta, multiplicacion o division");
