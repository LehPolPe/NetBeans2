 ...
 * and open the template in the editor. EN ESTA VERSION NO HAY MAS DE UNA PALABRA POR FILA
 */
package sopadeletras2;
...
public class SopaDeLetras2 {
    ...
    public static void checkFila(String[][] matriz, int f, boolean chckfl) {
        for (int i = 0; i < 20; i++) {
            if (matriz[f][i] != null) {
                chckfl = true;
            }
